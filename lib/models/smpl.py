...
BODY_MODEL_DIR = ROOT_DIR / 'data' / 'body_models'
JOINT_REGRESSOR_TRAIN_EXTRA = str(ROOT_DIR / 'data' / 'J_regressor_extra.npy')
JOINT_REGRESSOR_H36M = str(BODY_MODEL_DIR / 'J_regressor_h36m.npy')
SMPL_MEAN_PARAMS = str(BODY_MODEL_DIR / 'smpl_mean_params.npz')
SMPL_MODEL_DIR = str(BODY_MODEL_DIR / 'smpl')
